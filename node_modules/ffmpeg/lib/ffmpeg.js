...
var ffmpeg = function (/* inputFilepath, settings, callback */) {
	...
	var _ffmpegInfoConfiguration = function (settings) {
		...
		var ffmpegPath = (settings.ffmpegPath !== null && settings.ffmpegPath !== undefined && settings.ffmpegPath !== "") ? settings.ffmpegPath : "ffmpeg";
		utils.exec([ffmpegPath,'-formats','2>&1'], settings, function (error, stdout, stderr) {
